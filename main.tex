...
\usepackage{multirow}
\makeindex[columns=2, intoc, title=关键词索引]  % 两栏；目录中显示“索引”条目 , program=texindy , options=-z pinyin -C utf8
% configure fonts
% if not using CJK
...
\begin{document}
	\begin{titlepage}
		\includepdf[pages=1]{cover/dist/cover.pdf}
	\end{titlepage}
	\includepdf[pages=-]{cover/dist/signature.pdf}
	\includepdf[pages=-]{cover/dist/signature.pdf}
		...
		\begin{spacing}{1.15}
			...
			\section{Geometry}
				...
				\subsection{单插入动态凸包}
				\input{src/Geometry/dynamic_convex_hull.tex}
...
%				\inputminted{cpp}{src/Geometry/最近点对.cpp}
			...
			\section{Tree \& Graph}
				...
				\subsection{动态树直径}
					\inputminted{cpp}{src/TreeandGraph/动态树直径.cpp}
				\subsection{树哈希}
				...
				\subsection{无向图欧拉回路}
					\inputminted{cpp}{src/TreeandGraph/无向图欧拉回路.cpp}
				...
				\subsection{强连通分量}
					\inputminted{cpp}{src/TreeandGraph/scc.cpp}
				\subsection{边双连通分量}
					\inputminted{cpp}{src/TreeandGraph/EBCC.cpp}
				\subsection{边双连通分量(可处理非简单、联通图)}
					\inputminted{cpp}{src/TreeandGraph/边双连通分量.(可处理非简单、联通图）.cpp}
				\subsection{点双连通分量}
				...
				\subsection{OI码风费用流}
					\inputminted{cpp}{src/TreeandGraph/费用流oi-style.cpp}
				\subsection{K短路}
			...
			\section{Data Structure}
				...
				\subsection{第 k 大李超线段树}
					\inputminted{cpp}{src/DataStructure/kthLiChao.cpp}
				\subsection{笛卡尔树}
				...
				\subsection{Splay}
					\inputminted{cpp}{src/DataStructure/Splay.cpp}
				\subsection{LCT 动态树}
				...
				\subsection{动态dp}
					\input{src/DataStructure/ddp.tex}
					\inputminted{cpp}{src/DataStructure/ddp.cpp}
				\subsection{吉如一线段树}
					\input{src/DataStructure/beats.tex}
					\inputminted{cpp}{src/DataStructure/beats.cpp}
				% \subsection{有旋 Treap}
			...
			\section{Math 数学}
				\subsection{行列式求值(任意模数)}
					\inputminted{cpp}{src/Math/行列式求值(任意模数）.cpp}
				\subsection{高斯消元}
					\inputminted{cpp}{src/Math/高斯消元.cpp}
				...
				\subsection{连续拉格朗日插值}
					\inputminted{cpp}{src/Math/连续拉格朗日插值.cpp}
				\subsection{阶乘取模}
				...
				\subsection{在线卷积}
					\inputminted{cpp}{src/Math/在线卷积.cpp}
				\subsection{多项式}
					\inputminted{cpp}{src/Math/poly.cpp}
				\subsection{FFT}
					\inputminted{cpp}{src/Math/FFT.cpp}
				\subsection{NTT(大模数)}
					\inputminted{cpp}{src/Math/NTT_big.cpp}
				...
				\subsection{FWT}
					...
					\inputminted{cpp}{src/Math/myFWT.cpp}
			...
			\section{Tricks}
				...
				\subsection{带修的区间线性基}
					\input{src/tricks/lb.tex}
				\subsection{最长合法括号子序列长度}
					\input{src/tricks/Parentheses.tex}
				\subsection{区间或，区间与，区间异或}
					\inputminted{cpp}{src/tricks/orandxor.cpp}
				\subsection{枚举大小为 r 的子集}
					\inputminted{cpp}{src/tricks/sz_r.cpp}
				\subsection{模意义真分数还原}
					\inputminted{cpp}{src/tricks/approx.cpp}
				\section{Appendix}
				\begin{spacing}{0.4}
			...
			\section{Miscellany}
				...
				\subsection{Linux 运行脚本}
					\inputminted{cpp}{src/Miscellany/linux_r.cpp}
				\subsection{计时}
					\inputminted{cpp}{src/Miscellany/time.cpp}
				\subsection{对拍}
					\inputminted{sh}{src/Miscellany/duipai.sh}
					\inputminted{cpp}{src/Miscellany/duipai.cpp}
				\subsection{高精度}
					\inputminted{cpp}{src/Miscellany/bigint.cpp}
				...
				\subsection{NTT 模数表}
					$P = r\cdot2^k + 1$,原根为$g$
					\input{src/TipsandHints/NTTbase.tex}
				\subsection{Prime Table 质数表}
				 	\input{src/TipsandHints/Primes.tex}
