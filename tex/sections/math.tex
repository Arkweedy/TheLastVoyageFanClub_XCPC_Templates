			\TemplateSection[K0E510E020E990E2C0702CCF4C4CF8325010112010100]{Math}
				...
				\TemplateSubsection[KCE8D0DC97D0DCA2619C5BB0DC77B1FC2CB640101010100]{万能欧几里德}
					\TemplateCode{cpp}{src/Math/euclid.cpp}
				...
				\TemplateSubsection[K0E510E320E7007020D1C0D220702CC790D0101010100]{min\_25 筛}
					...
					\TemplateNote{src/Math/min25_examples.tex}
				\TemplateSubsection[KD0565BC454130101010100]{原根}
					\TemplateNote{src/Math/阶和原根.tex}
				\TemplateSubsection{Modulo-Arkweedy}
					以下代码块可按需独立抄取；重复的 \texttt{exgcd}、\texttt{inv}、\texttt{power} 用于保持单块自包含，不应将所有代码块原样拼入同一翻译单元。
					\paragraph*{exgcd}\index{exgcd!Arkweedy}
						\TemplateNote{src/Math/Modulo/exgcd.tex}
						\TemplateCode{cpp}{src/Math/Modulo/exgcd.cpp}
					\paragraph*{CRT}\index{CRT!Arkweedy}
						\TemplateNote{src/Math/Modulo/crt.tex}
						\TemplateCode{cpp}{src/Math/Modulo/crt.cpp}
					\paragraph*{exCRT}\index{exCRT!Arkweedy}
						\TemplateNote{src/Math/Modulo/excrt.tex}
						\TemplateCode{cpp}{src/Math/Modulo/excrt.cpp}
					\paragraph*{BSGS}\index{BSGS!Arkweedy}
						\TemplateNote{src/Math/Modulo/bsgs.tex}
						\TemplateCode{cpp}{src/Math/Modulo/bsgs.cpp}
					\paragraph*{exBSGS}\index{exBSGS!Arkweedy}
						\TemplateNote{src/Math/Modulo/exbsgs.tex}
						\TemplateCode{cpp}{src/Math/Modulo/exbsgs.cpp}
					\paragraph*{exLucas}\index{exLucas!Arkweedy}
						\TemplateNote{src/Math/Modulo/exlucas.tex}
						\TemplateCode{cpp}{src/Math/Modulo/exlucas.cpp}
					\paragraph*{Cipolla}\index{Cipolla!Arkweedy}
						\TemplateNote{src/Math/Modulo/Cipolla.tex}
						\TemplateCode{cpp}{src/Math/Modulo/Cipolla.cpp}
				...
				\TemplateSubsection{Poly Toolkit}
					\index{valueShift!Poly Toolkit}
					\TemplateNote{src/Math/PolyToolkit_valueShift.tex}
					\TemplateCode{cpp}{src/Math/PolyToolkit.cpp}
					\index{Berlekamp-Massey!Poly Toolkit}
					\TemplateNote{src/Math/PolyToolkit_BM.tex}
				\TemplateSubsection[fenyuanduoxiangshi]{分圆多项式}
					\TemplateNote{src/Math/分圆多项式.tex}
					\TemplateCode{cpp}{src/Math/分圆多项式.cpp}
				...
				\TemplateSubsection[K0E360702C61516D1416707020E230EA40E9901011202020202121212010100]{K 进制 FWT}
					\TemplateCode{cpp}{src/Math/K进制FWT.cpp}
