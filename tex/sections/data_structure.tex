			\TemplateSection[K0E1A0E020E990E0207020E910E990E8A0E9F0E0A0E990E9F0E8A0E210101120202020212010100]{Data Structure}
				...
				\TemplateSubsection[KC9117FC35C0DC50F13C5B63A0101010100]{莫队合集}
					...
					\TemplateSubsubsection{带修莫队}
						单点修改，区间查询颜色个数；块长常取 $n^{2/3}$。当序列长度、询问数与修改数同阶时，时间复杂度为 $O(n^{5/3})$。
				...
				\TemplateSubsection[KD16B0DCEE22BCCF4400727C620A9CD9F2BCB8110C5D222C2EA8E07020E360702CF1E0D072A01010202020302020202020202020203010100]{主席树（静态区间第 k 小）}
					\TemplateNote{src/DataStructure/主席树.tex}
					\TemplateCode{cpp}{src/DataStructure/主席树.cpp}
				...
				\TemplateSubsection{Treap}
					\TemplateSubsubsection{维护序列的Treap}
						\TemplateNote{src/DataStructure/TreapSeq-intro.tex}
						\TemplateCode{cpp}{src/DataStructure/TreapSeq.cpp}
						\TemplateNote{src/DataStructure/TreapSeq-usage.tex}
					\TemplateSubsubsection{维护多重集的Treap}
						\TemplateNote{src/DataStructure/TreapSet-intro.tex}
						\TemplateCode{cpp}{src/DataStructure/TreapSet.cpp}
						\TemplateNote{src/DataStructure/TreapSet-usage.tex}
